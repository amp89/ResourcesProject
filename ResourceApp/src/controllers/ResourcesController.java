...
//	public ModelAndView loadIndexPageGet(@ModelAttribute("currentUser") CurrentUser currentUser){
...
//	@RequestMapping(path="signIn.do", method=RequestMethod.POST)
	...
	@RequestMapping(path="confirm.do", method=RequestMethod.POST)
		public ModelAndView confirmAccount(@RequestParam("password") String password, @RequestParam("confirmationKey") String confirmationKey, @RequestParam("userName") String userName){
			ModelAndView mv = new ModelAndView();
